      ...
      <div className="absolute right-0 h-full w-1/2 flex flex-col gap-10 justify-center items-center ">
        ...
        <div className="w-full flex gap-10 justify-start items-center  ">
          <div className=" flex justify-between items-center group  ">
            ...
            <span className="pl-5 overflow-hidden text-4xl font-semibold text-black dark:text-dark-text transition-all duration-500 max-w-0 group-hover:max-w-xl " >React</span>
          </div>
          <div className=" flex justify-between items-center group  ">
            <LogosTailwindcssIcon className='h-[80px] w-[80px]' />
            <span className="pl-5 h-full overflow-hidden text-4xl font-semibold text-black dark:text-dark-text transition-all duration-500 max-w-0 group-hover:max-w-xl " >Tailwind</span>
          </div>
          <div className=" flex justify-between items-center group  ">
            <LogosTypescriptIcon className='h-[80px] w-[80px]' />
            <span className="pl-5 overflow-hidden h-full text-4xl font-semibold dark:text-dark-text transition-all duration-500 max-w-0 group-hover:max-w-xl " >Typescript</span>
          </div>
        </div>
      </div>
